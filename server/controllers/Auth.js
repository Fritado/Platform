...
exports.updateContactNumber = async (req, res) => {
  try {
    ...
    console.error(error)
    res.status(500).json({ message: 'Internal server error while updating contact number' })
  }
}
...
exports.getUserDetails = async (req, res) => {
  try {
    ...
    const user = await User.findById(userId).select('firstname lastname email contactNumber')
