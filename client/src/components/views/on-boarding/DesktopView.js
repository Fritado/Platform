        ...
        <div className="d-flex flex-row progress-box ">
          <div className="d-flex flex-column mx-auto box-style">
            ...
            <p className="text-center mt-1 ">
              ...
              <span className="text-primary">The performance score is calculated </span> directly
              from these metrics.
            ...
            <div className="d-flex flex-row mx-auto">
              ...
              <div className="d-flex flex-row ">
                <span className="ps-3">
                  <IoSquareSharp color="rgb(221, 207, 15)" className="icon" /> 50-89
                </span>
              </div>
              <div className="d-flex flex-row ">
                <span className="ps-3">
          ...
          <div className="d-flex box-style border-start ">
            <img src={imageUrl} alt="logo" className="d-flex p-3 mx-auto page-img border rounded" />
          </div>
        </div>
        {/**content div */}
        <div className="my-3 px-1">
          <h6 className="ps-2">METRICS</h6>
